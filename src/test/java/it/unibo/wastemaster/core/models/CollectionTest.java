...
class CollectionTest {
    ...
    void testConstructorAndGetters() {
        ...
        Collection collection = new Collection(customer, date, wasteType, status, 5, 123, true);
        ...
        assertEquals(123, collection.getScheduleId());
    ...
    void testGetInfo() {
        ...
        Collection collection = new Collection(customer, date, wasteType, status, 10, 456, false);

        String expectedInfo = String.format("Collection ID: %d, Customer: %s, Date: %s, Waste: %s, Status: %s, Cancel Limit Days: %d, Schedule ID: %d, Extra: %b",
                collection.getCollectionId(), customer.getName(), date.toString(), wasteType, status, collection.getCancelLimitDays(), collection.getScheduleId(), collection.isExtra());
        
        assertEquals(expectedInfo, collection.getInfo());
    }
