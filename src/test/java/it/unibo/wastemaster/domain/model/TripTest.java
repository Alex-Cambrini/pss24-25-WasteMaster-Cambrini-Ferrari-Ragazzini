...
class TripTest extends AbstractDatabaseTest {
        ...
        public void setUp() {
                ...
                operator2 = new Employee("Jane", "Doe", location, "jane.doe@example.com", "0987654321",
                                Employee.Role.OPERATOR, Employee.Licence.C1);
                operator3 = new Employee("Alice", "Smith", location, "alice.smith@example.com", "1122334455",
                                Employee.Role.OPERATOR, Employee.Licence.C1);
        ...
        void testDefaultStatusActive() {
                Trip t = new Trip("40100", vehicle, List.of(operator1), departureTime, expectedReturnTime,
                                Collections.emptyList());
