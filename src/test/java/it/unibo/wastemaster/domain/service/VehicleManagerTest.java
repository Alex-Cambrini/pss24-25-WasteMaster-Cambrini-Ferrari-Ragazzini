...
class VehicleManagerTest extends AbstractDatabaseTest {
        ...
        void testPlateNormalization() {
                Vehicle vehicleWithLowerCasePlate = new Vehicle("aa111aa", "Fiat", "Panda", VEHICLE_REGISTRATION_YEAR,
                ...
                Optional<Vehicle> dbVehicleOpt = getVehicleManager().findVehicleByPlate("aa111aa");
        ...
        void testUpdateVehiclePlate() {
                Vehicle vehicle = new Vehicle("CC333CC", "Toyota", "HiAce", VEHICLE_REGISTRATION_YEAR,
        ...
        @Test
        void testAddVehicle() {
                Vehicle toAddVehicle = new Vehicle("gg000gg", "Renault", "Master", VEHICLE_REGISTRATION_YEAR,
                                Vehicle.RequiredLicence.C1, Vehicle.VehicleStatus.IN_SERVICE, 3);
                ...
                Vehicle duplicate = new Vehicle("gg000GG", "Renault", "Master", VEHICLE_REGISTRATION_YEAR,
                                Vehicle.RequiredLicence.C1, Vehicle.VehicleStatus.IN_SERVICE, 3);
                assertThrows(IllegalArgumentException.class,
                                () -> getVehicleManager().addVehicle(duplicate));

                Vehicle withSpaces = new Vehicle("  AA000BB ", "Brand", "Model", VEHICLE_REGISTRATION_YEAR,
                                Vehicle.RequiredLicence.C1, Vehicle.VehicleStatus.IN_SERVICE, 2);
                getVehicleManager().addVehicle(withSpaces);

                Optional<Vehicle> savedNoSpacesOpt = getVehicleManager().findVehicleByPlate("AA000BB");
        ...
        void testUpdateVehicle() {
                ...
                Vehicle ghost = new Vehicle("ZZ999ZZ", "Ghost", "Model", VEHICLE_REGISTRATION_YEAR,
                                Vehicle.RequiredLicence.C1, Vehicle.VehicleStatus.IN_SERVICE, 1);
        ...
        void testGetAllowedLicences() {
                ...
                assertEquals(List.of(Licence.B, Licence.C1, Licence.C), getVehicleManager().getAllowedLicences(vb));
                assertEquals(List.of(Licence.C1, Licence.C), getVehicleManager().getAllowedLicences(vc1));
                assertEquals(List.of(Licence.C), getVehicleManager().getAllowedLicences(vc));
                assertThrows(IllegalArgumentException.class, () -> getVehicleManager().getAllowedLicences(null));
        }
        ...
        void testFindAllVehicle() {
                ...
                assertThrows(IllegalArgumentException.class, () -> getVehicleManager().findVehicleByPlate(null));
        }
}
