...
public class CollectionPlanManager {
    ...
    public void createNewCollectionPlan(Customer customer, CollectionPlan.Frequency frequency,
            ...
            CollectionPlan plan = new CollectionPlan(customer, frequency, status, wasteType);

            Date nextCollectionDate = calculateNextDate(plan);
            plan.setNextCollectionDate(nextCollectionDate);
            collectionPlanDAO.insert(plan);
    }
